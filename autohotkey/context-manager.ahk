...
;   Win+Shift+C  -> CM / Cliente A    (perfil Chrome aislado del cliente +
;                                      Notion del cliente)
...
#+e::{
    ...
    LaunchChrome(PROFILE_PERSONAL)      ; navegador personal de recursos
...
#+c::{
    ...
    LaunchChrome(PROFILE_CLI_A)         ; sesion AISLADA del cliente
    Run(NOTION)
    Sleep(2000)
